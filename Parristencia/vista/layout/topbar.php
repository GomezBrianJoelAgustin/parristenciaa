                        ...
                        <div class="site-header-shown">
                            ...
                            <div class="dropdown user-menu">
                                ...
                                <div class="dropdown-menu dropdown-menu-right pt-0" aria-labelledby="dd-user-menu">
                                    ...
                                    <h5 class="p-2 text-center bg-primary"><?php echo $_SESSION["nombre_profesor"]." ".$_SESSION["apellido_profesor"];?></h5>
                                    <a class="dropdown-item" href=""><span class="font-icon glyphicon glyphicon-user"></span>Perfil</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="../../../../controlador/controlladorCerrarSesion.php">
