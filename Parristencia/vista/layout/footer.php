        ...
        <script src="../../public/app/publico/js/.js"></script>
        <!-- datatables -->
    ...
    $('#example').DataTable({
        ...
        "pageLength": 10, // Puedes ajustar el número de registros a mostrar si lo deseas
        "language": {
            "emptyTable": "No hay información",
            "zeroRecords": "Sin resultados encontrados",
            "search": "Buscar:",
            // Otras configuraciones de lenguaje que necesites
        }
    });
});
        </script>
